...
NSString *const kMTTGPUImageBeautyFragmentShaderString = SHADER_STRING
(
...
@implementation MTTGPUImageBeautyFilter

- (instancetype)init {
    if (!(self = [super initWithFragmentShaderFromString:kMTTGPUImageBeautyFragmentShaderString])) {
        return nil;
    }
    _toneLevel = 0.5;
    _beautyLevel = 0.5;
...
- (void)setInputSize:(CGSize)newSize atIndex:(NSInteger)textureIndex {
    ...
    CGPoint offset = CGPointMake(2.0f / inputTextureSize.width, 2.0f / inputTextureSize.height);
    [self setPoint:offset forUniformName:@"singleSetpOffset"];
}

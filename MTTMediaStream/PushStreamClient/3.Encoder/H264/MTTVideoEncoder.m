...
#import "MTTVideoEncoder.h"

@implementation MTTVideoEncoder
{
...
+ (MTTVideoEncoder *)encoderForPath:(NSString *)path Height:(int)height andWidth:(int)width bitrate:(int)bitrate {
    MTTVideoEncoder *enc = [MTTVideoEncoder alloc];

...
+ (instancetype)defaultConfiguration {
    MTTLiveAudioConfiguration *audioConfig = [MTTLiveAudioConfiguration defaultConfigurationForQuality:MTTLiveAudioQuality_Default];
    return audioConfig;
}

+ (instancetype)defaultConfigurationForQuality:(MTTLiveAudioQuality)audioQuality {
    MTTLiveAudioConfiguration *audioConfig = [MTTLiveAudioConfiguration new];
    audioConfig.numberOfChannels = 2;
    switch (audioQuality) {
    case MTTLiveAudioQuality_Low: {
        audioConfig.audioBitrate = audioConfig.numberOfChannels == 1 ? MTTLiveAudioBitRate_32Kbps : MTTLiveAudioBitRate_64Kbps;
        audioConfig.audioSampleRate = MTTLiveAudioSampleRate_16000Hz;
    }
        break;
    case MTTLiveAudioQuality_Medium: {
        audioConfig.audioBitrate = MTTLiveAudioBitRate_96Kbps;
        audioConfig.audioSampleRate = MTTLiveAudioSampleRate_44100Hz;
    }
        break;
    case MTTLiveAudioQuality_High: {
        audioConfig.audioBitrate = MTTLiveAudioBitRate_128Kbps;
        audioConfig.audioSampleRate = MTTLiveAudioSampleRate_44100Hz;
    }
        break;
    case MTTLiveAudioQuality_VeryHigh: {
        audioConfig.audioBitrate = MTTLiveAudioBitRate_128Kbps;
        audioConfig.audioSampleRate = MTTLiveAudioSampleRate_48000Hz;
    }
        break;
    default:{
        audioConfig.audioBitrate = MTTLiveAudioBitRate_96Kbps;
...
- (BOOL)isEqual:(id)other {
    if (other == self) {
        ...
        MTTLiveAudioConfiguration *object = other;
...
- (id)copyWithZone:(nullable NSZone *)zone {
    MTTLiveAudioConfiguration *other = [self.class defaultConfiguration];
    return other;
}

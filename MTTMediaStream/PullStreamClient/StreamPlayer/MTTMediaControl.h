...
#import "MTTMediaGesturesView.h"
@protocol MTTKMediaPlayback;
...
@protocol MTTMediaControlDelegate <NSObject>
...
@interface MTTMediaControl : UIView
...
@property (nonatomic, weak) id<MTTKMediaPlayback> delegatePlayer;
@property (nonatomic, weak) id<MTTMediaControlDelegate>delegate;
...
@property (nonatomic, strong, readonly) MTTMediaGesturesView  *gesturesView;

...
@property (nonatomic, strong) MTTMediaGesturesView  *gesturesView;
...
@implementation MTTMediaControl
...
#pragma mark-- MTTMediaGesturesViewdelegate 代理
// 移动
...
- (void)creatSubviews {
    ...
    self.gesturesView = ({
        MTTMediaGesturesView *view =[MTTMediaGesturesView new];

...
// 屏幕宽度，跟横竖屏无关
#define kDEVICE_WIDTH (IS_LANDSCAPE ? kSCREEN_HEIGHT : kSCREEN_WIDTH)
// 屏幕高度，跟横竖屏无关
#define kDEVICE_HEIGHT (IS_LANDSCAPE ? kSCREEN_WIDTH : kSCREEN_HEIGHT)

// 当前窗口
#define kWindow [[UIApplication sharedApplication].delegate window]

// 小屏模式高度
#define kMinPlayerHeight (kSCREEN_WIDTH / 16 * 9)

@interface UIView (MTTExtend)
